...
// Source: github.com/ozoncp/ocp-howto-api/internal/producer (interfaces: Producer)
...
import (
	...
	producer "github.com/ozoncp/ocp-howto-api/internal/producer"
)
...
func (m *MockProducer) SendEvent(arg0 producer.Event) {
	m.ctrl.T.Helper()
